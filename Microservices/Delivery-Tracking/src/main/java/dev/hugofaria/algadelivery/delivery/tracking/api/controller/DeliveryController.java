package dev.hugofaria.algadelivery.delivery.tracking.api.controller;

import dev.hugofaria.algadelivery.delivery.tracking.api.model.CourierIdInput;
import dev.hugofaria.algadelivery.delivery.tracking.api.model.DeliveryInput;
import dev.hugofaria.algadelivery.delivery.tracking.domain.model.Delivery;
import dev.hugofaria.algadelivery.delivery.tracking.domain.repository.DeliveryRepository;
import dev.hugofaria.algadelivery.delivery.tracking.domain.service.DeliveryCheckpointService;
import dev.hugofaria.algadelivery.delivery.tracking.domain.service.DeliveryPreparationService;
